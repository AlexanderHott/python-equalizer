...
class AudioStream(object):
    def __init__(self):
        ...
        # pyaudio stuff
        self.FORMAT = pyaudio.paInt16  # Data Format
        self.CHANNELS = 1  #
        self.RATE = 44100  # RATE/2 = max audio range
        self.CHUNK = 1024 * 2  # amount of data being read per frame
        self.DEV_INDEX = 1  # 3 is desktop audio, 1 is mic
